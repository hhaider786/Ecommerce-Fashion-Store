...
export default async function SuccessPage({ searchParams }: { searchParams: Promise<{ order?: string }> }) {
  ...
  return (
    <>
      <Navigation />
      <main id="main" className="pt-28 pb-20 px-6 min-h-screen flex items-center justify-center">
        <div className="max-w-md text-center">
          ...
          <h1
            className="text-3xl md:text-4xl font-light text-[#111] mb-4"
          ...
          <Link
            href="/"
            className="inline-block px-8 py-3.5 text-xs tracking-[0.2em] uppercase bg-[#111] text-white hover:bg-[#333] transition-colors"
          >
            Continue shopping
          </Link>
          <ClearCart />
